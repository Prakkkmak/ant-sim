...
public class Simulation {
    ...
    public Simulation(int worldSize, int startingWorkers, int minutesPerTick,int refreshRate, int markedNumber) {
    ...
    public Simulation(int worldSize, int startingWorkers, int minutesPerTick,int refreshRate) {
        ...
        this.markedWorkersNumber = this.startingWorkers / 100;
    }
    ...
    public void init(){
        ...
        int startingTile = worldSize / 2;
            this.world.createQueen(startingTile,startingTile);
